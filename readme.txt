...
Also set your savestate directory. Please note that the directory needs to already exist.
5. Click 'New Game' and then launch the game of your choice on the console.
6. When the game has launched, click "Patch ROM".
...
To make a save state, either click "Make Savestate" within
savestate2snes or press the defined button combination on your controller. Making a savestate this way will also
store the state in your defined savestate directory.

If you have done a savestate with the controller, you can save that to your computer as well by clicking "Save Savestate".

"Load Savestate" will simply load a savestate from the list to the right.
